var org_mesa_xml_b2mml_allextensions_Module_Factory = function () {
  var org_mesa_xml_b2mml_allextensions = {
    name: 'org_mesa_xml_b2mml_allextensions',
    typeInfos: [{
        localName: 'QuantityType',
        typeName: {
          namespaceURI: 'http:\/\/www.mesa.org\/xml\/B2MML-AllExtensions',
  ...
  return {
    org_mesa_xml_b2mml_allextensions: org_mesa_xml_b2mml_allextensions
  };
};
if (typeof define === 'function' && define.amd) {
  define([], org_mesa_xml_b2mml_allextensions_Module_Factory);
}
else {
  var org_mesa_xml_b2mml_allextensions_Module = org_mesa_xml_b2mml_allextensions_Module_Factory();
  if (typeof module !== 'undefined' && module.exports) {
    module.exports.org_mesa_xml_b2mml_allextensions = org_mesa_xml_b2mml_allextensions_Module.org_mesa_xml_b2mml_allextensions;
  }
  else {
    var org_mesa_xml_b2mml_allextensions = org_mesa_xml_b2mml_allextensions_Module.org_mesa_xml_b2mml_allextensions;
  }
}